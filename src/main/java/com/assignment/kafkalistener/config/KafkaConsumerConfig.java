package com.assignment.kafkalistener.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, City> cityConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "city_consumer");
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(City.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, City> greetingKafkaListenerContainerFactory() {
